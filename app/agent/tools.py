...
def get_stock_quote(symbol: str) -> dict:
    """Get current price, fundamentals, PE ratio, market cap, analyst target,
    and 52-week range for a stock symbol (e.g. 'AAPL', 'TSLA', '0700.HK')."""
    return fetch_quote(symbol)


def get_technical_signals(symbol: str) -> dict:
    """Get 6-month price history with RSI-14, MACD, Bollinger Bands,
    1M/3M price change %, and 10-day avg volume for a stock symbol."""
